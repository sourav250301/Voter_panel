...
from ALL_STATE_DATA_BY_PP_ROUND.PP_Round_data_calculation import PP_Round_final_df as df
for i in range(1, 11):
...
# Function to calculate winner for a given decrement column
...
# --------------------------------------------------------------------------------------------------------------------- #
PP_decrease_max_per_ac_wise_df=df
